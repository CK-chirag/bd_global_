...
const HeroSection = ({ 
  ...
  highlightColor = "text-orange-400"
    ...
    return (
        <div className={`relative min-h-screen bg-gradient-to-r ${backgroundGradient}`}>
            {/* Background overlay */}
            ...
            {/* Main Content */}
            <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center -mt-20 pt-8">
                {/* Main Heading */}
