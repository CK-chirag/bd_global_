        ...
        <div className="hidden lg:flex items-center justify-between">
          ...
          <div className="flex items-center bg-white rounded-lg px-6 py-3 shadow-lg">
            ...
            <div className="flex items-center mr-4">
              ...
              <span className="text-gray-700 text-sm">+91 98xxx xxxx</span>
            </div>

            {/* WhatsApp Button */}
            <button className="bg-green-500 cursor-pointer hover:bg-green-600 text-white px-4 py-2 rounded-md mr-3 flex items-center text-sm font-medium transition-colors">
          ...
          <div className="lg:hidden mt-4 bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-4 bg-gray-50 space-y-3">
              ...
              <div className="flex flex-col space-y-2">
                <button className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-md flex items-center justify-center text-sm font-medium transition-colors">
