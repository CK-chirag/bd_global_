...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1,
      quote: "BD Global made our company registration process incredibly smooth. Their team was professional, transparent, and delivered everything on time. Highly recommended for startups!",
      name: "Rajesh Sharma",
    ...
    },
    {
      ...
      name: "Amit Kumar",
      title: "Director, Kumar Enterprises",
