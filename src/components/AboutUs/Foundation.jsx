  ...
  const foundationPillars = [
    {
      ...
      title: "Mission",
      description: "To empower businesses with seamless compliance and accounting solutions, enabling entrepreneurs to focus on growth while we handle the complexities."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
      ...
      title: "Vision",
      description: "To become India's most trusted business partner, making compliance simple, transparent, and accessible for every business, regardless of size."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
